...
def clean_data(df, df2):
    ...
    # Create a column that shows how often an apartment is occupied.     df_occupied['occupancy_rate'] = df_occupied['occupied'] / (df_occupied['available'] + df_occupied['occupied'])


    # we can remove the other unnecessary columns
